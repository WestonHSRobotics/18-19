...
public class DrivingOpTest extends LinearOpMode{
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            powerFR = Range.clip(this.gamepad1.left_stick_y - this.gamepad1.left_stick_x - this.gamepad1.right_stick_x, -1, 1);
            powerBL = Range.clip(this.gamepad1.left_stick_y + this.gamepad1.left_stick_x - this.gamepad1.right_stick_x, -1, 1);
            powerBR = Range.clip(this.gamepad1.left_stick_y - this.gamepad1.left_stick_x + this.gamepad1.right_stick_x, -1, 1);
